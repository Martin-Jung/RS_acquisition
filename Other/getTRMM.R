...
#' 
#' @examples 
#' getTRMM(fileLocation="~/",url="ftp://disc2.nascom.nasa.gov/data/TRMM/Gridded/",product="3B43",version=7,year=2012,BBlonMin=-3.82,BBlonMax=-3.63,BBlatMin=52.43,BBlatMax=52.52)
#'

getTRMM <- function(fileLocation = "~/",
  ...
  # Change â€œ3B43.12â€³ accordingly to the downloaded data. 
